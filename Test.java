...
{  
    ...
    {  
        ...
        if(current==2)  
        {  
            l.setText("3: Where is system class defined?");  
            jb[0].setText("java.lang.package");jb[1].setText("java.util.package ");jb[2].setText("java.lo.package");jb[3].setText("None");  
        }  
        if(current==3)  
        {  
            l.setText("4: Expected created by try block is caaught in which block.?");  
        ...
        if(current==7)  
        {  
            l.setText("8: What is the implict return type of constructor?");  
        ...
        if(current==9)  
        {  
            l.setText("10: Which provides runtime enviroment for java byte code to be executed?");  
